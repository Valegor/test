...
/**
 * TemplatesSearch represents the model behind the search form of `app\modules\admin\models\Templates`.
 */
class TemplatesSearch extends Templates
{
    ...
    public function rules()
    {
        return [
            ...
            [['name', 'subtitle', 'notes', 'object', 'img', 'created_at', 'updated_at'], 'safe'],
        ];
    }
